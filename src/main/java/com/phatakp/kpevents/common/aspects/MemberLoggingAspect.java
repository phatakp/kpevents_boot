...
public class MemberLoggingAspect {
    ...
    @Pointcut("within(com.phatakp.kpevents.users.services.impl.MemberServiceImpl)")
    public void memberControllers(){}

    @Around("memberControllers()")
    public Object logAroundMember(ProceedingJoinPoint joinPoint) throws Throwable {
