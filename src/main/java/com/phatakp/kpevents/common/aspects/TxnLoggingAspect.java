...
@Component
@Slf4j
public class TxnLoggingAspect {

    @Value("${app.env}")
    private String appEnv;

    @Pointcut("within(com.phatakp.kpevents.transactions.services.impl.TransactionServiceImpl)")
    public void txnControllers(){}

    @Around("txnControllers()")
    public Object logAroundTxn(ProceedingJoinPoint joinPoint) throws Throwable {
